...
const formSchema = z.object({
  name: z.string({
    required_error: "Por favor, insira um nome para a escala.",
  }),
  date: z.string({
    required_error: "Por favor, insira uma data para a escala.",
  }),
  direction: z.string({
    required_error: "Por favor, insira alguem para dirigir a escala.",
  }),
    ...
    <div>
      <Drawer>
        <DrawerTrigger asChild>
          <Button
            variant="default"
            className="bg-amber-500 z-20  hover:bg-amber-100 hover:text-amber-500"
          >
            Criar Escala
          </Button>
        </DrawerTrigger>
        <DrawerContent>
          <div className="container mx-auto px-4">
            <DrawerHeader>
              ...
              <DrawerDescription>
                Preencha os campos abaixo para criar a escala.
              </DrawerDescription>
            </DrawerHeader>
            <Form {...form}>
              <form
                      ...
                      render={({ field }) => (
                        <FormItem className="min-w-[170px] max-w-[240px] relative">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <Button
                              type="button"
                              className={`w-[48px] rounded-[6px] h-[48px]`}
